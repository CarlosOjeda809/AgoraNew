            ...
            <div class="flex flex-col items-center">
                <div class="w-full max-w-2xl space-y-8 rounded-lg">
                    ...
                    <form @submit.prevent="crearForo" class="mt-8 space-y-6">
                        ...
                        <div class="space-y-2">
                            <button type="submit"
                                class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-gray-900 hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black">
